...
- **Web Frameworks & UI:** React, Tailwind CSS, Alpine.js
- **Backend & APIs:** FastAPI, Flask, Groq API, REST APIs, Gemini AI
- **Tools & Workflow:** Git, GitHub, VS Code, Bash, Render, Vercel
